...
double DistancePerCount = (2 * 3.14 * wheel_radius) / 240;
...
int main(int argc, char** argv){
    ...
    ros::Subscriber sub_wheel1 = n.subscribe("Enc_A", 1000, Wheel1_Callback);
    ros::Subscriber sub_wheel2 = n.subscribe("Enc_B", 1000, Wheel2_Callback);
    ros::Subscriber sub_wheel3 = n.subscribe("Enc_C", 1000, Wheel3_Callback);
	...
	double dt = (current_time - last_time).toSec();
    	...
    	double vy = ((dist_wheel3 - dist_wheel1 * 0.5 - dist_wheel2 * 0.5))*-1;
    	double vx = ((dist_wheel1 * 0.86602 - dist_wheel2 * 0.86602));
    	double vth = (dist_wheel1 + dist_wheel2 + dist_wheel3)*36;
